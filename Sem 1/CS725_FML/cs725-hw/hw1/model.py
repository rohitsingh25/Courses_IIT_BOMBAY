...
### for evaluation write these commands
#  python3 train.py --model logistic_regression --dataset binary --num_epochs 1000 --learning_rate 0.1 --momentum 0.9
# python3 train.py --model linear_classifier  --dataset iris --num_epochs 100 --learning_rate 0.1 --momentum 0
# python3 evaluate_submission.py